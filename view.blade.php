...
@section('title')
  ...
  <title>D10014 - Affiliate program</title>
...
@section('css')
  ...
  <link rel="stylesheet" type="text/css" href="{!! (\Request::secure() ? "https://" : "http://") . (\Request::getHost()) . ":" . (\Request::getPort()); !!}/public/D10014/css/c.css?rand={!! mt_rand(1000,9999); !!}">
  <!-- document css: stop -->
...
@section('js')
  ...
  <script src="{!! (\Request::secure() ? "https://" : "http://") . (\Request::getHost()) . ":" . (\Request::getPort()); !!}/public/D10014/js/j.js?rand={!! mt_rand(1000,9999); !!}"></script>
  <!-- document js: stop -->
